...
public class ModuleRetry {
	...
	private HashMap<CategorieHeures, List> heures;
	...
	public Semestres getSemestres() { return this.semestres;}
	...
	public HashMap<CategorieHeures, List> getHeures() { return this.heures; }
	public void setSemestres(Semestres semestres) {this.semestres = semestres;}
	...
	public void setHeures   (HashMap<CategorieHeures, List> heures) { this.heures = heures; }
