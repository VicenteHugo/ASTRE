...
public class Ajout extends Action {
	...
	public Ajout(Intervenants inter) {
		...
		this.requetes = "INSERT INTO Intervenants" + Etat.nom + " (nomInt, prenomInt, heureMinInt, heureMaxInt, categInt) VALUES (?,?,?,?,?)";
	...
	public Ajout(CategorieIntervenant cat) {
		...
		this.requetes = "INSERT INTO CategorieIntervenants" + Etat.nom + " (codeCatInt, libCatInt, coefCatInt, heureMinCatInt, heureMaxCatInt) VALUES (?,?,?,?,?)";

		this.info = new ArrayList<>(List.of(cat.getCodeCatInt(), cat.getLibCatInt(), cat.getCoefCatInt(), cat.getHeureMinCatInt(), cat.getHeureMaxCatInt()));
	}
}
